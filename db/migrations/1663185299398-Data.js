module.exports = class Data1663185299398 {
  name = 'Data1663185299398'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "ips_account" ("id" character varying NOT NULL, "account_id" character varying, "ips_id" character varying, CONSTRAINT "PK_5a587a25d655896b526a7da2e8a" PRIMARY KEY ("id"))`)
